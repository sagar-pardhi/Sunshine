...
public class Utility {
    ...
    public static float getLocationLangitude(Context context){
        SharedPreferences prefs =
                PreferenceManager.getDefaultSharedPreferences(context);
     ...
     */
    public static String getFriendlyDayString(Context context, long dateInMillis, boolean displayLongDay) {
        ...
        // is "Today, June 24"
        if (displayLongDay && julianDay == currentJulianDay) {
